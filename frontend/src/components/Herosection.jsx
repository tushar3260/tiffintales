      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full py-28 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-orange-300 bg-orange-100">
            ...
            <motion.div
              ...
              className="space-y-2"
            >
              <p className="text-gray-400 text-xs font-semibold uppercase tracking-wider">What are you craving?</p>
