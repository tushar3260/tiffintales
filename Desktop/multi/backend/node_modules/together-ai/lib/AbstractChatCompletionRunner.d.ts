...
import { type Completions, type ChatCompletion, type ChatCompletionMessage, type ChatCompletionMessageParam, type CompletionCreateParams } from "../resources/chat/completions.js";
import { APIUserAbortError, TogetherError } from "../error.js";
...
import { ChatCompletionUsage } from "../resources/chat/completions.js";
...
export declare abstract class AbstractChatCompletionRunner<Events extends CustomEvents<any> = AbstractChatCompletionRunnerEvents> {
    ...
    protected _createChatCompletion(completions: Completions, params: CompletionCreateParams, options?: RequestOptions): Promise<ChatCompletion>;
    protected _runChatCompletion(completions: Completions, params: CompletionCreateParams, options?: RequestOptions): Promise<ChatCompletion>;
